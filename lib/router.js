...
FlowRouter.route('/merchants/register/success', {
    action: ()=> {
        BlazeLayout.render('Layout', {top: "header", main: "registration_success"});
    },
    triggersEnter: [function(context, redirect) {
      setTimeout(()=>FlowRouter.go('/login'),2000);
    }]
});
...
FlowRouter.route('/merchants/add', {
    action: ()=> {
        BlazeLayout.render('Layout', {top: "header", main: "add_funds"});
    }
});
FlowRouter.route('/merchants/transfer/:friend', {
    action:(params, queryParams)=> {
        BlazeLayout.render('Layout', {top: "header", main: "transfer_funds"});
    }
});
